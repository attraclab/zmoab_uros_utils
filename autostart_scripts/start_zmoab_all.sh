...
export DISPLAY=:0.0
export LOGFILE=/home/$USER/$rosws/src/$rospackage/autostart_scripts/zmoab_all.log
...
do
		...
		echo "Starting zmoab_all" >> $LOGFILE
		
		ros2 launch zmoab_uros_utils  zmoab_all.launch.py  show_log:=False wheel_sep:=0.36 >> $LOGFILE
